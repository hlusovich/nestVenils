...
describe('Profiles', () => {
  ...
  it(`/GET api/profiles/`, () => {
    return request(app.getHttpServer())
      .get('/api/profiles/')
      .expect(200)
      .expect(profileService.getAllProfiles());
  });
  it(`/GET api/profiles/id`, () => {
    ...
    return request(app.getHttpServer())
      ...
      .expect(200)
      .expect(profileService.getProfileById(id) as Object);
  });
  ...
  it(`/PATCH api/profiles/id`, () => {
    ...
    return request(app.getHttpServer())
      ...
      .set({ authorization: email })
      .expect(200)
      .expect(profileService.updateProfile(id));
  });
  ...
  it(`/GET api/profiles/id auth with incorrect email`, () => {
    const id = v4();
    const token: string =
      'Bearer ' + jwtService.sign({ email: 'email', role: Role.USER });
    return request(appWithAuth.getHttpServer())
      .get(`/api/profiles/${id}`)
